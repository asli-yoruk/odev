...

{
    ...
    Label lblBussinessName, lblAddress, lblPhone, lblWebsite,lblRecyles, lblFind, lblRecyclers;
    ...
    public static void main(String[] args)
    {
        ...
        //Centered Title
        Font font = myFrame.getFont();
        String currentTitle = myFrame.getTitle().trim();
        FontMetrics fm = myFrame.getFontMetrics(font);
        ...
        myFrame.setTitle(pad + currentTitle);
    }
    ...
    public LocalRecylers()
    {
        ...
        txtSection = LocateATextArea(myLayout, txtSection, 30, 270, 70, 10);
    ...
    {
        lblBussinessName = LocateALabel(myLabelLayout, lblBussinessName, "Business Name:", 20, 25);
        lblAddress = LocateALabel(myLabelLayout, lblAddress, "Address:", 20, 50);
        lblPhone = LocateALabel(myLabelLayout, lblPhone, "Phone:", 20, 75);
        lblWebsite = LocateALabel(myLabelLayout, lblWebsite, "Website:", 20, 100);
        lblRecyles = LocateALabel(myLabelLayout, lblRecyles, "Recycles:", 20, 125);
        lblFind = LocateALabel (myLabelLayout, lblFind, "Find:", 320,100);
        lblRecyclers = LocateALabel (myLabelLayout, lblRecyclers, "Recyclers List:", 30,245);

        lblBussinessName.setBackground(Color.GREEN);
        lblAddress.setBackground(Color.GREEN);
        lblFind.setBackground(Color.GREEN);
        lblPhone.setBackground(Color.GREEN);
        lblWebsite.setBackground(Color.GREEN);
        lblRecyles.setBackground(Color.GREEN);
        lblRecyclers.setBackground(Color.GREEN);
    }
    ...
    public void LocateTextFields(SpringLayout myTextFieldLayout)
    {
        ...
        txtPhone = LocateATextField(myTextFieldLayout, txtPhone, 10, 130, 75);
